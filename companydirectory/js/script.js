...
$("#searchInp").on("keyup", function () {
  ...
  $("#filterPersonnelModal").on("show.bs.modal", function (e) {
    var currentfilterDepartmentSelect = $('#filterPersonnelDepartment').val(); 
    var currentfilterLocationSelect = $('#filterPersonnelLocation').val(); 

    filterPersonnels(currentfilterDepartmentSelect, currentfilterLocationSelect);
...
function PersonnelTableBody(data){
  ...
  data.forEach(function(item, index) {
    ...
    deleteButton.classList = "btn btn-primary btn-sm ms-1";
...
$("#filterPersonnelDepartment").change(function () {
  ...
  if (this.value > 0) {
    ...
    filterPersonnels(departmentID.value, locationID.value);
...
function filterPersonnels(departmentID, locationID)
{
  $.ajax({
    url:
