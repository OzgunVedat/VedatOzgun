...
//GetById
  ...
  document.getElementById("editPersonnelForm").addEventListener("submit", (e) => {
    ...
    if (firstName.value == "" || lastName.value == "" || email.value == "" || departmentID.value == "" || personnelID.value == "") {
      ...
      success: function (result) {
        ...
        if (resultCode == 200) {
          ...
          if(result.data.length > 0){
            alert("There are personnel affiliated with this department, you can not delete!");
          }
          else{
    ...
    $.ajax({
      ...
      success: function (result) {
        ...
        if (resultCode == 200) {
          ...
          if(result.data.length > 0){
            alert("There are departments affiliated with this location, you can not delete!");
          }
          else{
...
document.getElementById("insertPersonnelForm").addEventListener("submit", (e) => {
  ...
  if (firstName.value == "" || lastName.value == "" || email.value == "" || departmentID.value == "") {
    alert("Ensure you input a value in fields!");
  } else { 
    $.ajax({
      url:
