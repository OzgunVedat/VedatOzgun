...
function getExchangerate(currencyCode) {
    ...
    $.ajax({
        ...
        success: function(result) {
            document.getElementById('countryCurrencyCodeIdEasyButton').innerHTML = currencyCode;
			document.getElementById('countryCurrencyUSDIdEasyButton').innerHTML = result.data.conversion_rates.USD + " USD";
        },
        error: function(jqXHR, textStatus, errorThrown) {
            console.log(textStatus, errorThrown);
        }
